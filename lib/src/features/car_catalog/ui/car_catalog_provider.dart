...
///
/// The `CarCatalogProvider` is an implementation of [InheritedNotifier],
/// which allows
/// widgets to access and listen to updates from the [CarCatalogInteractor].
///
/// This provider simplifies state management by exposing the
/// [CarCatalogInteractor]
/// via the [of] method, ensuring that the widget tree can react to changes in
/// the car catalog state.
class CarCatalogProvider extends InheritedNotifier<CarCatalogInteractor> {
  /// Creates an instance of [CarCatalogProvider].
  ///
  /// - [child] is the widget subtree that can access the
  /// [CarCatalogInteractor].
  /// - [interactor] is the [CarCatalogInteractor] used to manage the car
  /// catalog state.
  ...
  /// Retrieves the [CarCatalogInteractor] from the nearest
  /// [CarCatalogProvider].
  ///
